...
export const adminNavSections: AdminNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/orders", labelKey: "nav.orders", icon: ShoppingBag, permission: "orders.view" },
      { href: "/admin/escrow", labelKey: "nav.escrows", icon: Lock, permission: "escrow.view" },
      { href: "/admin/wallets", labelKey: "nav.wallets", icon: Wallet, permission: "wallets.view" },
      { href: "/admin/payments", labelKey: "nav.payments", icon: CreditCard, permission: "payments.view" },
      { href: "/admin/disputes", labelKey: "nav.disputes", icon: Scale, permission: "disputes.view" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/finance", labelKey: "nav.finance", icon: Banknote, permission: "finance.view" },
