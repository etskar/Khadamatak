  ...
  return (
    <div className="sticky top-[calc(var(--topnav-height)+0.5rem)] z-20 rounded-2xl border border-border bg-card/95 p-3 shadow-sm backdrop-blur-xl">
      <div className="flex items-center gap-3">
        ...
        <Link
          href="/create-post"
          className="flex h-11 flex-1 items-center rounded-full border border-border bg-muted/60 px-4 text-start text-sm text-muted-foreground transition hover:border-brand-300 hover:bg-muted"
        >
          {t("whatToShare")}
        </Link>
      </div>
